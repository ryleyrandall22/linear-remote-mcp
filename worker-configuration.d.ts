// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 1a128d89323aa36e1f3a7db633b48983)
...
declare namespace Cloudflare {
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").LinearMCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINEAR_CLIENT_ID" | "LINEAR_CLIENT_SECRET">> {}
}
